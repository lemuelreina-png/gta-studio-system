# Main Pi Rules – GTA Front Desk

These rules govern all front desk interactions.

1. Maximum of three questions if information is missing:
   - Placement
   - Size (in inches)
   - Black & grey or color

2. Exact quotes are never given.
